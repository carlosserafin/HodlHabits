        ...
        <div className="flex hidden h-full w-[344px] flex-shrink-0 flex-col items-start gap-y-8 rounded-large bg-gradient-to-b from-default-100 via-danger-100 to-secondary-100 px-8 py-6 shadow-small lg:flex">
          ...
          <div>
            ...
            <div className="mt-1 text-base font-medium leading-6 text-default-500">
              Create a new challenge for your community to participate in.
            </div>
          </div>
          {/* Desktop Steps */}
          <VerticalSteps
            ...
            steps={[
              {
                title: "Basic challenge details",
                description: "Setting up your challenge",
              },
              {
                title: "Videos to include",
                description: "Select the videos to include in your challenge",
              },
              {
                title: "Confirm challenge",
                description: "Review and confirm your challenge details",
              },
            ]}
